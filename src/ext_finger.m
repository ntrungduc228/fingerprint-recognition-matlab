...
function [ ret, thinned, binim, minutiae_img ] = ext_finger( img, display_flag )
...
% Enhancement -------------------------------------------------------------
    ...
    %figure; imshow(binim); title('Filtered and Binarized Image !!!');
% Making Mask -------------------------------------------------------------
    ...
    %axes(handles.thinn_img); imshow(thinned,[]);
...
% Return Minutiae ---------------------------------------------------------
    if display_flag == 1
        ...
        if display_flag==1
            ...
            %figure;imshow(combined);title('Minutiae 2');
            minutiae_img=combined;
        end;
    end
    ret=minutiae;
end